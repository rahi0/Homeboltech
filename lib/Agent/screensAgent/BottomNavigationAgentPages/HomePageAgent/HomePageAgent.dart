...
import 'package:homeboltech/Agent/screensAgent/BottomNavigationAgentPages/ProfilePageAgent/agentsListAgentScreen.dart';
import 'package:homeboltech/Agent/screensAgent/BottomNavigationAgentPages/ProfilePageAgent/cancelledProjectsAgentPage.dart';
import 'package:homeboltech/Agent/screensAgent/BottomNavigationAgentPages/ProfilePageAgent/completedProjectsAgentPage.dart';
import 'package:homeboltech/Agent/screensAgent/BottomNavigationAgentPages/ProfilePageAgent/currentProjectsAgentPage.dart';
import 'package:homeboltech/Agent/screensAgent/BottomNavigationAgentPages/ProfilePageAgent/currentTasksAgentPage.dart';
import 'package:homeboltech/Agent/screensAgent/BottomNavigationAgentPages/ProfilePageAgent/paymentAndBillingAgentScreen.dart';
import 'package:homeboltech/Agent/screensAgent/BottomNavigationAgentPages/ProfilePageAgent/pendingProjectsAgentPage.dart';
import 'package:homeboltech/Agent/screensAgent/BottomNavigationAgentPages/ProfilePageAgent/pendingTaskAgentPage.dart';
import 'package:homeboltech/routeTransition/routeAnimation.dart';
import 'package:smooth_page_indicator/smooth_page_indicator.dart';

import 'notificationsAgentPage.dart';
          ...
          children: <Widget>[
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: CurrentProjectsAgentPage()),
                        );
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: CompletedProjectsAgentPage()),
                        );
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: PendingProjectsAgentPage()),
                        );
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: CancelledProjectsAgentPage()),
                        );
                      },
                      child: Container(
                        child: Text(
            ...
            InkWell(
              onTap: () {
                Navigator.of(context).pop();
                Navigator.push(
                    context, FadeRoute(page: PaymentAndBillingAgentScreen()));
              },
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: CurrentTasksAgentPage()),
                        );
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: PendingTaskAgentPage()),
                        );
                      },
                      child: Container(
                        child: Text(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  FadeRoute(page: AgentsListAgentScreen()),
                );
              },
              child: Container(
              ...
              children: [
                ...
                IconButton(
                  ...
                  onPressed: () {
                    Navigator.push(
                      context,
                      ScaleRoute(page: NotificationsAgentPage()),
                    );
                  },
                ),
              ],
