...
class AgentProfileAgentScreen extends StatefulWidget {
  @override
  _AgentProfileAgentScreenState createState() => _AgentProfileAgentScreenState();
}

class _AgentProfileAgentScreenState extends State<AgentProfileAgentScreen> {
