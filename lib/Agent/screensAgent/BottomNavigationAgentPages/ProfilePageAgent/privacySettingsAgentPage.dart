...
class PrivacySettingsAgent extends StatefulWidget {
  @override
  _PrivacySettingsAgentState createState() => _PrivacySettingsAgentState();
}

class _PrivacySettingsAgentState extends State<PrivacySettingsAgent> {
