...
import 'currentProjectDetailsAgentPage.dart';


class CurrentProjectsAgentPage extends StatefulWidget {
  @override
  _CurrentProjectsAgentPageState createState() => _CurrentProjectsAgentPageState();
}

class _CurrentProjectsAgentPageState extends State<CurrentProjectsAgentPage> {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          ScaleRoute(page: CurrentProjectDetailsAgentPage()),
                        );
                      },
                      child: Container(
                        decoration: BoxDecoration(
