...
class CompletedProjectsAgentPage extends StatefulWidget {
  @override
  _CompletedProjectsAgentPageState createState() => _CompletedProjectsAgentPageState();
}

class _CompletedProjectsAgentPageState extends State<CompletedProjectsAgentPage> {
