...
import 'agentProfileAgentScreen.dart';

class AgentsListAgentScreen extends StatefulWidget {
  @override
  _AgentsListAgentScreenState createState() => _AgentsListAgentScreenState();
}

class _AgentsListAgentScreenState extends State<AgentsListAgentScreen> {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          ScaleRoute(page: AgentProfileAgentScreen()),
                        );
                      },
                      child: Container(
                        decoration: BoxDecoration(
