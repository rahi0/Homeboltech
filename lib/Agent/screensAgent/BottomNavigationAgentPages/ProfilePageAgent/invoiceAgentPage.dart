...
import 'invoiceAgentAgentProfile.dart';


class InvoiceAgentPage extends StatefulWidget {
  @override
  _InvoiceAgentPageState createState() => _InvoiceAgentPageState();
}

class _InvoiceAgentPageState extends State<InvoiceAgentPage> {
  @override
            ...
            children: [
              GestureDetector(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    ScaleRoute(page: InvoiceAgentAgentProfile()),
                  );
                },
                child: Row(
                  children: [
