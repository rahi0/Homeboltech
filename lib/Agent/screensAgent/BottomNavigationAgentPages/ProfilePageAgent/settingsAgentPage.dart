...
import 'package:homeboltech/Agent/screensAgent/BottomNavigationAgentPages/ProfilePageAgent/resetPasswordAgentScreen.dart';
import 'package:homeboltech/Agent/screensAgent/BottomNavigationAgentPages/ProfilePageAgent/tNcAgentScreen.dart';
import 'package:homeboltech/routeTransition/routeAnimation.dart';
import 'privacySettingsAgentPage.dart';

class SettingsAgentPage extends StatefulWidget {
  @override
  _SettingsAgentPageState createState() => _SettingsAgentPageState();
}

class _SettingsAgentPageState extends State<SettingsAgentPage> {
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: ResetPasswordAgentScreen()),
                          );
                        },
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: PrivacySettingsAgent()),
                          );
                        },
                        child: _buildListItemRow(
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: TncAgentScreen()),
                          );
                        },
                        child: Container(
