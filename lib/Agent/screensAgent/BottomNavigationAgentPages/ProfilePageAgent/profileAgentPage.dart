...
import 'editProfileAgentPage.dart';
import 'settingsAgentPage.dart';

class ProfileAgentPage extends StatefulWidget {
  @override
  _ProfileAgentPageState createState() => _ProfileAgentPageState();
}
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: EditProfileAgentPage()),
                          );
                        },
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: SettingsAgentPage()),
                          );
                        },
                        child: _buildListItemRow(
                          Icons.settings,
