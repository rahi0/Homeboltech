...
import 'currentTasksAgentPage.dart';


class CreateNewTaskAgentScreen extends StatefulWidget {
  @override
  _CreateNewTaskAgentScreenState createState() => _CreateNewTaskAgentScreenState();
}

class _CreateNewTaskAgentScreenState extends State<CreateNewTaskAgentScreen> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    SizeRoute(page: CurrentTasksAgentPage()),
                  );
                },
                child: Container(
