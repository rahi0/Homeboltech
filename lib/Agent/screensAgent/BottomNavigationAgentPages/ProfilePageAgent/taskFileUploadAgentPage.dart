...
class TaskFileUploadAgentPage extends StatefulWidget {
  @override
  _TaskFileUploadAgentPageState createState() => _TaskFileUploadAgentPageState();
}

class _TaskFileUploadAgentPageState extends State<TaskFileUploadAgentPage> {
