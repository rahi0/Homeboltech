...
import 'package:homeboltech/Agent/screensAgent/BottomNavigationAgentPages/ProfilePageAgent/taskDetailsAgentPage.dart';
import 'package:homeboltech/routeTransition/routeAnimation.dart';

class CurrentTasksAgentPage extends StatefulWidget {
  @override
  _CurrentTasksAgentPageState createState() => _CurrentTasksAgentPageState();
}

class _CurrentTasksAgentPageState extends State<CurrentTasksAgentPage> {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          ScaleRoute(page: TaskDetailsAgentPage()),
                        );
                      },
                      child: Container(
                        decoration: BoxDecoration(
