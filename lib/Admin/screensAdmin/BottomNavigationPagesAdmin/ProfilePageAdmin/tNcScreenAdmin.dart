...
class TncAdminScreen extends StatefulWidget {
  @override
  _TncAdminScreenState createState() => _TncAdminScreenState();
}

class _TncAdminScreenState extends State<TncAdminScreen> {
