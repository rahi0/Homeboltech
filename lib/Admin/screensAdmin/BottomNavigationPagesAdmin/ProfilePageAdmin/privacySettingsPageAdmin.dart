...
class PrivacySettingsAdmin extends StatefulWidget {
  @override
  _PrivacySettingsAdminState createState() => _PrivacySettingsAdminState();
}

class _PrivacySettingsAdminState extends State<PrivacySettingsAdmin> {
