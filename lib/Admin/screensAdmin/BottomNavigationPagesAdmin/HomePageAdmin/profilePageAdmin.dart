...
import 'package:homeboltech/Admin/screensAdmin/BottomNavigationPagesAdmin/ProfilePageAdmin/editProfilePageAdmin.dart';
import 'package:homeboltech/Admin/screensAdmin/BottomNavigationPagesAdmin/ProfilePageAdmin/settingsPageAdmin.dart';
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: EditProfileAdminPage()),
                          );
                        },
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: SettingsAdminPage()),
                          );
                        },
                        child: _buildListItemRow(
                          Icons.settings,
