...
class CreateNewProjectAdminScreen extends StatefulWidget {
  @override
  _CreateNewProjectAdminScreenState createState() =>
      _CreateNewProjectAdminScreenState();
}

class _CreateNewProjectAdminScreenState
    extends State<CreateNewProjectAdminScreen> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    SizeRoute(page: CurrentProjectsAdminPage()),
                  );
                },
                child: Container(
