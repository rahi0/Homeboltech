...
import 'package:homeboltech/Admin/screensAdmin/BottomNavigationPagesAdmin/HomePageAdmin/agentProfileScreenAdmin.dart';
import 'package:homeboltech/routeTransition/routeAnimation.dart';

class AgentsListAdminScreen extends StatefulWidget {
  @override
  _AgentsListAdminScreenState createState() => _AgentsListAdminScreenState();
}

class _AgentsListAdminScreenState extends State<AgentsListAdminScreen> {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          ScaleRoute(page: AgentProfileAdminScreen()),
                        );
                      },
                      child: Container(
                        decoration: BoxDecoration(
