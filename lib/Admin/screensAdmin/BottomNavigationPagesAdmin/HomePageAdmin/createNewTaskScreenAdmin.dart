...
class CreateNewTaskAdminScreen extends StatefulWidget {
  @override
  _CreateNewTaskAdminScreenState createState() =>
      _CreateNewTaskAdminScreenState();
}

class _CreateNewTaskAdminScreenState extends State<CreateNewTaskAdminScreen> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    SizeRoute(page: CurrentTasksAdminPage()),
                  );
                },
                child: Container(
