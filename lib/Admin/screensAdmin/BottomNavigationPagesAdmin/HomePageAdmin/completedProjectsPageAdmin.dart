...
class CompletedProjectsAdminPage extends StatefulWidget {
  @override
  _CompletedProjectsAdminPageState createState() => _CompletedProjectsAdminPageState();
}

class _CompletedProjectsAdminPageState extends State<CompletedProjectsAdminPage> {
