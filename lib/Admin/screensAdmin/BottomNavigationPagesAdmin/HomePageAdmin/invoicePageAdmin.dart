...
import 'package:homeboltech/Admin/screensAdmin/BottomNavigationPagesAdmin/HomePageAdmin/invoiceAgentProfileAdmin.dart';
            ...
            children: [
              GestureDetector(
                ...
                onTap: () {
                  Navigator.push(
                    context,
                    ScaleRoute(page: InvoiceAgentProfileAdmin()),
                  );
                },
                child: Row(
                  children: [
