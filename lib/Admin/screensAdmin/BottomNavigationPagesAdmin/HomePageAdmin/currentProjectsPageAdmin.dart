...
import 'package:flutter_icons/flutter_icons.dart';
import 'package:homeboltech/Admin/screensAdmin/BottomNavigationPagesAdmin/HomePageAdmin/currentProjectDetailsPageAdmin.dart';
import 'package:homeboltech/routeTransition/routeAnimation.dart';
import 'package:percent_indicator/percent_indicator.dart';

class CurrentProjectsAdminPage extends StatefulWidget {
  @override
  _CurrentProjectsAdminPageState createState() =>
      _CurrentProjectsAdminPageState();
}

class _CurrentProjectsAdminPageState extends State<CurrentProjectsAdminPage> {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          ScaleRoute(page: CurrentProjectDetailsAdminPage()),
                        );
                      },
                      child: Container(
                        decoration: BoxDecoration(
