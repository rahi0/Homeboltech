...
import 'package:homeboltech/Admin/screensAdmin/BottomNavigationPagesAdmin/HomePageAdmin/taskFileUploadPageAdmin.dart';
import 'package:homeboltech/routeTransition/routeAnimation.dart';
import 'package:intl/intl.dart';

class TaskDetailsAdminPage extends StatefulWidget {
  final taskData;
  TaskDetailsAdminPage(this.taskData);
  @override
                                ...
                                child: Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      _buildContainer(
                                        'Type:',
                                        '${widget.taskData.project.addendum.name}',
                                      ),
                                      _buildDivider(),
                                      _buildContainer(
                                        'Assign Date:',
                                        widget.taskData.createdAt == null ? "" :
                                        "${DateFormat.yMMMMd().format(widget.taskData.createdAt)}"// start date oito
                                        //'Novermber 12, 2020',
                                      ),
                                      _buildDivider(),
                                      _buildContainer(
                                        'Duration:',
                                        '${widget.taskData.duration} hour',
                                      ),
                                      _buildDivider(),
                                      _buildContainer(
                                        'Status:',
                                            ...
                                            child: Stack(
                                              children: [
                                                Container(
                                                  ...
                                                  child: CircleAvatar(
                                                    radius: 25,
                                                    backgroundImage: widget.taskData.tech.image != null ?
                                            NetworkImage("${widget.taskData.tech.image}")
                                            : AssetImage(
