...
class AddAgentAdminScreen extends StatefulWidget {
  @override
  _AddAgentAdminScreenState createState() => _AddAgentAdminScreenState();
}

class _AddAgentAdminScreenState extends State<AddAgentAdminScreen> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: ////////////////////// save button start //////////////////////
        ...
        onTap: () {
          Navigator.push(
            context,
            SizeRoute(page: AgentsListAdminScreen()),
          );
        },
        child: Container(
