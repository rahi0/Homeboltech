...
import 'currentProjectDetailsPage.dart';

class CurrentProjectsPage extends StatefulWidget {
  @override
  _CurrentProjectsPageState createState() => _CurrentProjectsPageState();
}

class _CurrentProjectsPageState extends State<CurrentProjectsPage> {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          ScaleRoute(page: CurrentProjectDetailsPage()),
                        );
                      },
                      child: Container(
                        decoration: BoxDecoration(
