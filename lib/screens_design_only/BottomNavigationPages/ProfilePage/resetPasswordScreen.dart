...
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/resetPassVerificationPage.dart';
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    ScaleRoute(page: ResetPassVerificationPage()),
                  );
                },
                child: Container(
