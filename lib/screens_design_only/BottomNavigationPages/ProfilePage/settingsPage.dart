...
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/privacySettingsPage.dart';
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/resetPasswordScreen.dart';
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/tNcScreen.dart';
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: ResetPasswordScreen()),
                          );
                        },
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: PrivacySettings()),
                          );
                        },
                        child: _buildListItemRow(
