...
class PaymentAndBillingScreen extends StatefulWidget {
  @override
  _PaymentAndBillingScreenState createState() =>
      _PaymentAndBillingScreenState();
}

class _PaymentAndBillingScreenState extends State<PaymentAndBillingScreen> {
