...
import 'package:homeboltech/screens_design_only/BottomNavigationPages/HomePage/notificationsPage.dart';
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/agentsListScreen.dart';
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/cancelledProjectsPage.dart';
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/completedProjectsPage.dart';
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/currentProjectsPage.dart';
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/currentTasksPage.dart';
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/paymentAndBillingScreen.dart';
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/pendingProjectsPage.dart';
import 'package:homeboltech/screens_design_only/BottomNavigationPages/ProfilePage/pendingTaskPage.dart';
          ...
          children: <Widget>[
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: CurrentProjectsPage()),
                        );
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: CompletedProjectsPage()),
                        );
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: PendingProjectsPage()),
                        );
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: CancelledProjectsPage()),
                        );
                      },
                      child: Container(
                        child: Text(
                  ...
                  children: [
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: CurrentTasksPage()),
                        );
                      },
                      child: Container(
                    ...
                    GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          FadeRoute(page: PendingTaskPage()),
                        );
                      },
                      child: Container(
                        child: Text(
            ...
            GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                  context,
                  FadeRoute(page: AgentsListScreen()),
                );
              },
              child: Container(
