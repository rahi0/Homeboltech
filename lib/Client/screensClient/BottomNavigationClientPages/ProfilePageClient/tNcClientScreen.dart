...
class TncClientScreen extends StatefulWidget {
  @override
  _TncClientScreenState createState() => _TncClientScreenState();
}

class _TncClientScreenState extends State<TncClientScreen> {
