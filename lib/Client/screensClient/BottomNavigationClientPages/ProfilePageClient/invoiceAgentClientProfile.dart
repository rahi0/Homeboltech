...
class InvoiceAgentClientProfile extends StatefulWidget {
  @override
  _InvoiceAgentClientProfileState createState() =>
      _InvoiceAgentClientProfileState();
}

class _InvoiceAgentClientProfileState extends State<InvoiceAgentClientProfile> {
