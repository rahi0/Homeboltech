...
class PrivacySettingsClient extends StatefulWidget {
  @override
  _PrivacySettingsClientState createState() => _PrivacySettingsClientState();
}

class _PrivacySettingsClientState extends State<PrivacySettingsClient> {
