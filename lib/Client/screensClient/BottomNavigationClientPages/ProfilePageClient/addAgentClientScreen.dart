...
import 'agentsListClientScreen.dart';

class AddAgentClientScreen extends StatefulWidget {
  @override
  _AddAgentClientScreenState createState() => _AddAgentClientScreenState();
}

class _AddAgentClientScreenState extends State<AddAgentClientScreen> {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: ////////////////////// save button start //////////////////////
        ...
        onTap: () {
          Navigator.push(
            context,
            SizeRoute(page: AgentsListClientScreen()),
          );
        },
        child: Container(
