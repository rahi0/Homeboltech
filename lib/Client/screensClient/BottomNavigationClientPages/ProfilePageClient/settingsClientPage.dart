...
import 'package:homeboltech/Client/screensClient/BottomNavigationClientPages/ProfilePageClient/resetPasswordClientScreen.dart';
import 'package:homeboltech/Client/screensClient/BottomNavigationClientPages/ProfilePageClient/tNcClientScreen.dart';
import 'package:homeboltech/routeTransition/routeAnimation.dart';

import 'privacySettingsClientPage.dart';

class SettingsClientPage extends StatefulWidget {
  @override
  _SettingsClientPageState createState() => _SettingsClientPageState();
}

class _SettingsClientPageState extends State<SettingsClientPage> {
                    ...
                    children: [
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: ResetPasswordClientScreen()),
                          );
                        },
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: PrivacySettingsClient()),
                          );
                        },
                        child: _buildListItemRow(
                      ...
                      GestureDetector(
                        onTap: () {
                          Navigator.push(
                            context,
                            ScaleRoute(page: TncClientScreen()),
                          );
                        },
                        child: Container(
