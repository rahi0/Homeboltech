...
import 'currentProjectsClientPage.dart';

class CreateNewProjectClientScreen extends StatefulWidget {
  @override
  _CreateNewProjectClientScreenState createState() =>
      _CreateNewProjectClientScreenState();
}

class _CreateNewProjectClientScreenState
    extends State<CreateNewProjectClientScreen> {
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    SizeRoute(page: CurrentProjectsClientPage()),
                  );
                },
                child: Container(
