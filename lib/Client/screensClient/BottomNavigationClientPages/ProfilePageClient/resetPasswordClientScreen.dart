...
import 'package:homeboltech/Client/screensClient/BottomNavigationClientPages/ProfilePageClient/resetPassVerificationClientPage.dart';
import 'package:homeboltech/routeTransition/routeAnimation.dart';

class ResetPasswordClientScreen extends StatefulWidget {
  @override
  _ResetPasswordClientScreenState createState() =>
      _ResetPasswordClientScreenState();
}

class _ResetPasswordClientScreenState extends State<ResetPasswordClientScreen> {
  @override
            ...
            children: [
              ...
              GestureDetector(
                onTap: () {
                  Navigator.push(
                    context,
                    ScaleRoute(page: ResetPassVerificationClientPage()),
                  );
                },
                child: Container(
