...
import 'package:homeboltech/Client/screensClient/BottomNavigationClientPages/ProfilePageClient/agentProfileClientScreen.dart';
import 'package:homeboltech/routeTransition/routeAnimation.dart';

class AgentsListClientScreen extends StatefulWidget {
  @override
  _AgentsListClientScreenState createState() => _AgentsListClientScreenState();
}

class _AgentsListClientScreenState extends State<AgentsListClientScreen> {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          ScaleRoute(page: AgentProfileClientScreen()),
                        );
                      },
                      child: Container(
                        decoration: BoxDecoration(
