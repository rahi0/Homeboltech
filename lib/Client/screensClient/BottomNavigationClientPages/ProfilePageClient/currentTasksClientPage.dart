...
import 'package:homeboltech/Client/screensClient/BottomNavigationClientPages/ProfilePageClient/taskDetailsClientPage.dart';
import 'package:homeboltech/routeTransition/routeAnimation.dart';

class CurrentTasksClientPage extends StatefulWidget {
  @override
  _CurrentTasksClientPageState createState() => _CurrentTasksClientPageState();
}

class _CurrentTasksClientPageState extends State<CurrentTasksClientPage> {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return GestureDetector(
                      onTap: () {
                        Navigator.push(
                          context,
                          ScaleRoute(page: TaskDetailsClientPage()),
                        );
                      },
                      child: Container(
                        decoration: BoxDecoration(
